...
vim.keymap.set('n', '<leader>Y', [['+Y]], { desc = "[Y]ank into the system clipboard with line" })
...
vim.keymap.set('n', '<C-X>', '<cmd>bprevious <bar> bdelete #<CR>', { desc = 'Close buffer' })
-- Split
vim.keymap.set('n', '<leader>h', ':<C-U>split<CR>', { desc = "[H]rizontal split" })
vim.keymap.set('n', '<leader>v', ':<C-U>vsplit<CR>', { desc = "[V]ertical split" })
-- Undo Panel
