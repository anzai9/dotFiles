...
lsp.format_on_save({
  ...
  servers = {
    ...
    ['html'] = { 'html' },
    ['cssls'] = { 'css', 'scss', 'less' },
    ['prettierd'] = { 'json', 'yaml', 'html', 'css', 'scss', 'less', 'markdown', 'javascript', 'typescript',
      'typescriptreact', 'typescript.tsx', 'javascriptreact', 'javascript.jsx', 'rust', 'lua', 'python' },
    ['prismals'] = { 'prisma' },
    ['null-ls'] = {
...
require('mason-lspconfig').setup({
  ensure_installed = { 'tsserver', 'rust_analyzer', 'lua_ls', 'jsonls', 'yamlls', 'html', 'cssls', 'prismals' },
  handlers = {
    lsp.default_setup,
  },
})
