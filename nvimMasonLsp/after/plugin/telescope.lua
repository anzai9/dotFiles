...
vim.keymap.set('n', '<leader>ft',
               '<cmd>TodoTelescope keywords=TODO,FIX,FIXME<cr>', keymapOpts)
...
vim.keymap.set('n', '<C-p>', function() custom_actions.project_files() end,
               {silent = true})
...
custom_actions._multiple_open = function(prompt_bufnr, open_cmd)
    ...
    if search_res_count == 0 then return end
